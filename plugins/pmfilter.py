...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    # Thanks to @CoderluffyTG for fixing this 
        ...
        buttons = [[
            InlineKeyboardButton('⚜️ ᴜᴘᴅᴀᴛᴇꜱ ᴄʜᴀɴɴᴇʟ ⚜️', url='https://t.me/@Movies_Compass_Bot')
        ],[
            InlineKeyboardButton('🔍 ɢʀᴏᴜᴘ¹', url='https://t.me/@Movies_Compass_Bot'),
            InlineKeyboardButton('ɢʀᴏᴜᴘ² 🔎', url='https://t.me/@Movies_Compass_Bot')
        ],[
            InlineKeyboardButton('✉️ ʀᴇǫᴜᴇꜱᴛ ɢʀᴏᴜᴘ ✉️', url='https://t.me/@Movies_Compass_Bot')
        ],[
...
async def advantage_spell_chok(client, msg):
    ...
    try:
        ...
        if not g_s:
            ...
            button = [[
                       InlineKeyboardButton("📝 ʀᴇǫᴜᴇꜱᴛ ʜᴇʀᴇ", url=f"https://t.me/Rahat146Tm")
            ]]
            if NO_RESULTS_MSG:
