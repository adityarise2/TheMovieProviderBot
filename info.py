...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://ajprivaate:uknow@cluster0.3oo2y.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
if HAS_SSL:
    URL = "https://numerous-karleen-ajconemis-3ed112dc.koyeb.app/".format(FQDN)
else:
    URL = "https://numerous-karleen-ajconemis-3ed112dc.koyeb.app/".format(FQDN)
